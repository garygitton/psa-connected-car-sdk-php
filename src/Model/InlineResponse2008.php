...
class InlineResponse2008 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'listAlert' => '\Psa\ConnectedCar\Model\InlineResponse2008ListAlert[]',
        'vin' => 'string',
        'contract' => 'string'
    ];
    ...
    {
        $this->container['listAlert'] = isset($data['listAlert']) ? $data['listAlert'] : null;
     ...
     * Gets listAlert
     *
     * @return \Psa\ConnectedCar\Model\InlineResponse2008ListAlert[]
     */
    public function getListAlert()
    {
        return $this->container['listAlert'];
    }

    /**
     * Sets listAlert
     *
     * @param \Psa\ConnectedCar\Model\InlineResponse2008ListAlert[] $listAlert listAlert
     *
     * @return $this
     */
    public function setListAlert($listAlert)
    {
        $this->container['listAlert'] = $listAlert;
