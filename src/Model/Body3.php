...
class Body3 implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['listvin'] = isset($data['listvin']) ? $data['listvin'] : null;
        $this->container['listcontract'] = isset($data['listcontract']) ? $data['listcontract'] : null;
    }
     ...
     * @return string[]
     */
    public function getListvin()
    {
        return $this->container['listvin'];
    }

    /**
     * Sets listvin
     *
     * @param string[] $listvin listvin
     *
     * @return $this
     */
    public function setListvin($listvin)
    {
        $this->container['listvin'] = $listvin;
    ...
    {
        return $this->container['listcontract'];
    }

    /**
     * Sets listcontract
     *
     * @param string[] $listcontract listcontract
     *
     * @return $this
     */
    public function setListcontract($listcontract)
    {
        $this->container['listcontract'] = $listcontract;
